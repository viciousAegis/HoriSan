...
class Accountability(commands.Cog):
    ...
    async def on_message(self, message):
        if message.channel.id == 865508378775781406 and not message.author.bot:
    ...
    async def on_raw_reaction_add(self, reaction):
        ...
        """
        if reaction.channel_id == 865508378775781406 and not reaction.member.bot:
            guild_ = discord.utils.get(self.bot.guilds, id=840129026412904471)
            channel_ = discord.utils.get(guild_.channels, id=865508378775781406)
